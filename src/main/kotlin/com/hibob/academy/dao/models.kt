...
data class Owner(val name: String, val companyId: Long, val employeeId: String)

data class PetData(val id: Long, var name: String, val type: PetType, val companyId: Long, val dateOfArrival: Date, val ownerId: Long?)
